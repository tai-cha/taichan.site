...
- AntigravityでのGemini 3 Proの特有の癖としてImplamation Planの提案後、質問をしただけで承認や拒否と受け取ることがあったので、「`明確な同意なしで勝手に先走って実装をしないこと。実装を開始する際には**明確な同意**をもって実装を開始すること`」と指示
