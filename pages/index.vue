...
<template>
  <main>
    <div :class="$style.container">
      ...
      <span :class="$style.guideForNadesskey">もしかして: お探しのサイトは<a href="https://mi.taichan.site"><Icon :class="$style.icon" name="tai:nadesskey" />なですきー</a></span>
